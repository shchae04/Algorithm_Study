 ...
 *
 * 알고리즘과 boj11728.java의 비교:
 * - boj11728: 정렬된 두 배열을 병합하는 투 포인터 알고리즘
 * - boj15961: 원형 배열에서 고정 크기 윈도우의 최적값을 찾는 슬라이딩 윈도우
 * - 공통점: 두 알고리즘 모두 선형 시간복잡도 O(N)으로 효율적인 해결
 * - 차이점: 11728은 병합 정렬의 기본 연산, 15961은 최적화 문제 해결 기법
 */
